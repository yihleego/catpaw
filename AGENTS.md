...
## Project Overview
**Cat Paw** is a Rust-based desktop application utilizing the Bevy game engine (v0.18.0). It renders an interactive, stylized 2D cat paw that overlays the screen, originating from the bottom center and following the mouse cursor.
